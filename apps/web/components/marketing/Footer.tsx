      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8 mb-8">
          <div className="col-span-1 md:col-span-2">
            <Link href="/" className="text-2xl font-bold italic tracking-tighter text-white mb-4 block">
              PLANO<span className="text-orange-500">PACE</span>
            </Link>
            <p className="text-gray-400 max-w-xs">
              A revolução do treinamento de corrida. Tecnologia aplicada à sua performance.
            </p>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-2 text-gray-400 text-sm">
              ...
              <li><a href="/#features" className="hover:text-orange-500 transition-colors">Integrações</a></li>
              <li><a href="/#testimonials" className="hover:text-orange-500 transition-colors">Depoimentos</a></li>
            </ul>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-2 text-gray-400 text-sm">
              ...
              <li><a href="mailto:contato@planopace.com.br" className="hover:text-orange-500 transition-colors">Contato</a></li>
            </ul>
          </div>
        </div>
        ...
        <div className="border-t border-white/10 pt-8 flex flex-col md:flex-row justify-between items-center">
          ...
          <div className="flex space-x-6 mt-4 md:mt-0">
            <Link href="/registro" className="text-gray-400 hover:text-orange-500 transition-colors text-sm font-medium">
              Criar conta grátis
            </Link>
          </div>
        </div>
